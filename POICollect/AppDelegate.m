...
{
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.tianditu.tj.POICollect" in the application's documents directory.
...
- (NSManagedObjectModel*)managedObjectModel
{
    ...
    NSURL* modelURL = [[NSBundle mainBundle] URLForResource:@"POICollect" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator*)persistentStoreCoordinator
{
    ...
    NSURL* storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"POICollect.sqlite"];
    NSError* error = nil;
