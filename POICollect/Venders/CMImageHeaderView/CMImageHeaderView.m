...
@implementation CMImageHeaderView
...
{
    CMImageHeaderView* headerView = [[CMImageHeaderView alloc] initWithFrame:CGRectMake(0, 0, headerSize.width, headerSize.height)];
...
{
    CMImageHeaderView* headerView = [[CMImageHeaderView alloc] initWithFrame:CGRectMake(0, 0, subView.frame.size.width, subView.frame.size.height)];
